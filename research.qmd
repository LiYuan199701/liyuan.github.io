...
<img src="images/headshots/Headshots/research-headshot.jpeg" alt="Professional portrait of Li Yuan (Leon)">
</div>

::: {.publications-manuscripts}

This page summarizes my research projects, publications, and selected research projects. It includes manuscripts under review, manuscripts in progress, and published papers across machine learning, data science, and biomedical applications. Each project includes a brief summary and links to papers or code where available.
...
Faculty collaborators: [Tracey E. George](https://law.vanderbilt.edu/bio/tracey-george/) and [Albert Yoon](https://jackmanlaw.utoronto.ca/people/albert-yoon).

[View faculty collaborator profile](https://law.vanderbilt.edu/bio/tracey-george/){.btn .btn-primary}
...
Author: **Li Yuan**. Advisor: [Jing Cao, Ph.D.](https://people.smu.edu/jingcao/).
...
<div class="research-toc" role="complementary" aria-label="Research table of contents">
<div class="research-toc-title">On this page</div>
<nav id="research-item-toc"></nav>
</div>
...
document.addEventListener("DOMContentLoaded", function () {
  const toc = document.getElementById("research-item-toc");
  const content = document.querySelector(".research-layout .publications-manuscripts");
  if (!toc || !content) return;

  const list = document.createElement("ul");
  content.querySelectorAll("section[id] > h2, section[id] > h3").forEach(function (heading) {
    const section = heading.parentElement;
    const item = document.createElement("li");
    const link = document.createElement("a");
    link.href = "#" + section.id;
    link.textContent = heading.textContent.replace("Anchor", "").trim();
    item.className = heading.tagName === "H2" ? "research-toc-section" : "research-toc-item";
    link.addEventListener("click", function () {
      toc.querySelectorAll("a").forEach(function (tocLink) {
